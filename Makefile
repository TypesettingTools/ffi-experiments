...
CPPSOURCES  := $(wildcard download-manager/*.cpp)
CSOURCES    := $(wildcard download-manager/*.c)
...
$(DM_OBJECTS): | $(OBJDIR)/download-manager/
...
$(DownloadManagerLua): download-manager/DownloadManager.moon | $(OBJDIR)
	@printf "\e[1;35mMOONC\e[m $@\n"
	$(shell ./BuildLua.sh $< $@)
